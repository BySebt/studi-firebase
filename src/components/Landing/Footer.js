...
import { ReactComponent as SvgDecoratorBlob1 } from "../../icons/svg-decorator-blob-9.svg";

const Container = tw.div`relative bg-purple-500 text-gray-100 -mb-8 -mx-8 px-8 py-20 lg:py-24`;
...
const CopywrightNotice = tw.p`text-center text-sm sm:text-base mt-8 md:mt-0 font-medium`;
